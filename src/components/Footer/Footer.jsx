    ...
    <div className='footer' style={{ backgroundImage:  `url(${footerImage})` }}>
        ...
        <div className='footer-information-container'>
            ...
            <div className='footer-social-icon-container'>
                <a href='https://www.facebook.com/share/18uYtdPG2Y/' target='_blank'>
                    <svg className='social-icon facebook-icon' fill="#ffffff" viewBox="0 0 24 24">
                ...
                <a href='https://www.instagram.com/kovaarch?igsh=MTEyaGRkcTB4b3JiZg==' target='_blank' >
                    <svg className='social-icon instagram-icon' viewBox="0 0 24 24" fill="none">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"/>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
