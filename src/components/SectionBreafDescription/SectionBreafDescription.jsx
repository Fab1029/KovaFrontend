...
const SectionBreafDescription = ({information}) => {

  return (
    <div className='section-breaf-description'>
        
        <SectionTitle title={'Construyendo'} subtitle={'Momentos'}/>
        <div className='section-breaf-description-container-info'>
            <p className='section-breaf-description-text'>
                {information.description}
            </p>
            
            <StyledLink prompt={'Ver mas'} color={'#5B8095'} link={'/WhoWeAre'}/>
        </div>

        <ul className='info-card-list'>
            {information.services.map((service, index) => (
              <li key={index}> <InfoCard title={service.title} subtitle={service.subTitle} description={service.description} 
              image={
              <svg className='icon' viewBox="0 0 1800 1800">
              <g id="Layer"><g>
              <path className='icon-color' fill="#253646" d="M1541.606,1540.146l0.009-0.008c35.598-35.594,35.598-93.52,0-129.121
              ...
              <path className='icon-color' fill="#253646" d="M1700.934,402.736c0.021-0.026,0.047-0.043,0.068-0.065c0.044-0.043,0.083-0.091,0.127-0.134l5.504-5.505
              ...
              <path className='icon-color' fill="#253646" d="M506.941,804.479l56.789-56.789l-454.446-454.45l185.432-185.437l87.924,87.932l-63.792,63.783
                ...
                />
              <path className='icon-color' fill="#253646" d="M1778.944,1478.287c-0.726-0.729-1.478-1.424-2.241-2.085l-505.282-505.273l-151.159,151.159l50.259,50.26
...
export default SectionBreafDescription