...
const SectionWhoWeAre = () => {
    return (
        <div className='section-whoWeAre'>
            <SectionTitle title={'Quienes'} subtitle={'Somos'}/>
            <div className='section-whoWeAre-container-info'>
                <p className='section-whoWeAre-text'>
            ...
            <ul className='info-card-list'>
                <li> <InfoCard title={'Valores'} subtitle={''} description={'Poner algo referente en este apartado'} 
                  image={
                ...
                <li> <InfoCard title={'Proposito'} subtitle={''} description={'Poner algo referente en este apartado'} 
                  image={
                  <svg className='icon' viewBox="0 0 1800 1800">
                  <g id="Layer"><g>
                  <path className='icon-color' fill="#253646" d="M1541.606,1540.146l0.009-0.008c35.598-35.594,35.598-93.52,0-129.121
                ...
                <li> <InfoCard title={'Compromiso'} subtitle={''} description={'Poner algo referente en este apartado'} 
                  image={
                  <svg className='icon' viewBox="0 0 1800 1800">
                  <g id="Layer"><g>
                  <path className='icon-color' fill="#253646" d="M1541.606,1540.146l0.009-0.008c35.598-35.594,35.598-93.52,0-129.121
