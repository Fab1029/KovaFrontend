...
const ProjectSlider = ({navBar, viewMore}) => {
  ...
  return (
    <div key={index} className='project-slider'>
      <div className='project-image' style={{backgroundImage: `url(${projects[index].image})`}}/>
      ...
      <div className='slider'>
        ...
        <div className='name-slider'>
          ...
          <h1 className='project-subtitle'>{projects[index].subtitle}</h1>
          {viewMore}
        </div>
