  ...
  return (
    <div className='section-our-projects'>
      ...
      <div className='section-our-projects-container'>
          <div className='section-our-projects-slider'><ProjectSlider navBar={''} projects={projects} header={''}/></div> 
          <div className='section-our-projects-description'>
            ...
            <StyledLink className='uu' prompt={'Ver más'} color={'#5B8095'} link={'/ProjectsGallery'}/>
          </div>
      </div>
